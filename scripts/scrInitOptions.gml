///scrInitOptions()
//Game options
global.gameName = "I Wanna Relax With Needle 3"; //Name that will be displayed on the game window
...
global.savePassword = "iwannarelax2021"; //This will decide what password will be applied for encoding saves, the longer the password is the encryption will be more secure
global.totalSaves = 3; //The number of save slots you wanna use
global.totalItems = 0; //The number of items your game may have
global.totalBossItems = 6; //The number of boss items your game may have
global.totalAchievements = 0; //The number of achievements your game may have 
...
global.autosaveItems = true; //If this is set to true the items will be saved upon getting them
...
//Misc. options
global.startRoom = rStage0; //The room where the game will start
global.useClearRoom = true; //If you wanna use the clear room (like a portal room) set this to true
global.clearRoom = rPortal1; //The room you wanna be sent to as a clear room
global.clearButton = ord("M"); //The button you wanna use to return to the clear room
